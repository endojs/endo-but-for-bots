# #1389: build(deps): bump decode-uri-component from 0.2.0 to 0.2.2

- **URL:** https://github.com/endojs/endo/pull/1389
- **State:** OPEN
- **Author:** @app/dependabot
- **Created:** 2022-12-05T03:34:13Z
- **Updated:** 2023-04-14T18:10:35Z
- **Closed:** <no value>
- **Merged:** <no value>
- **Base:** master
- **Head:** dependabot/npm_and_yarn/decode-uri-component-0.2.2
- **Draft:** false
- **Files:** 1 (+3 −3)
- **Labels:** `dependencies`
...
- **What:** Dependabot bump of `decode-uri-component` 0.2.0 to 0.2.2.
...
- `393e9df0da0df21e05922fa83428c0ea5813c326` build(deps): bump decode-uri-component from 0.2.0 to 0.2.2

# #1014: chore(deps): bump node-fetch from 2.6.1 to 2.6.7

- **URL:** https://github.com/endojs/endo/pull/1014
- **State:** OPEN
- **Author:** @app/dependabot
- **Created:** 2022-01-25T15:29:10Z
- **Updated:** 2023-04-20T21:02:35Z
- **Closed:** <no value>
- **Merged:** <no value>
- **Base:** master
- **Head:** dependabot/npm_and_yarn/node-fetch-2.6.7
- **Draft:** false
- **Files:** 1 (+23 −3)
- **Labels:** `dependencies`
...
- **What:** Dependabot bump of `node-fetch` 2.6.1 → 2.6.7 (security patch for redirect header leakage).
...
- `8f4d59b48d22eb456c49dcd4f622a48753ebc262` chore(deps): bump node-fetch from 2.6.1 to 2.6.7
- `d66c73fb336be5b1e929e1015edc3241540a2394` Merge branch 'master' into dependabot/npm_and_yarn/node-fetch-2.6.7
- `10216e035f9ac52747f5cb2471fccc4c5c465f3e` Merge branch 'master' into dependabot/npm_and_yarn/node-fetch-2.6.7

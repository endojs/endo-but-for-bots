# #1223: build(deps): bump shell-quote from 1.7.2 to 1.7.3

- **URL:** https://github.com/endojs/endo/pull/1223
- **State:** CLOSED
- **Author:** @app/dependabot
- **Created:** 2022-06-22T22:15:20Z
- **Updated:** 2022-12-14T23:45:30Z
- **Closed:** 2022-12-14T23:45:29Z
- **Merged:** <no value>
- **Base:** master
- **Head:** dependabot/npm_and_yarn/shell-quote-1.7.3
- **Draft:** false
- **Files:** 1 (+3 −3)
- **Labels:** `dependencies`
...
- **What:** Dependabot bump of `shell-quote` 1.7.2 → 1.7.3 (CVE-2021-42740 Windows drive-letter regex fix); closed unmerged.
...
- `3c8c8936cd9ed0edaafc8f7a3efcb3a4805c4282` build(deps): bump shell-quote from 1.7.2 to 1.7.3
...
### @dependabot (CONTRIBUTOR) — 2022-12-14T23:45:27Z

# #1361: build(deps): bump loader-utils from 1.4.0 to 1.4.2

- **URL:** https://github.com/endojs/endo/pull/1361
- **State:** OPEN
- **Author:** @app/dependabot
- **Created:** 2022-11-13T12:27:29Z
- **Updated:** 2023-04-14T18:10:34Z
- **Closed:** <no value>
- **Merged:** <no value>
- **Base:** master
- **Head:** dependabot/npm_and_yarn/loader-utils-1.4.2
- **Draft:** false
- **Files:** 1 (+3 −3)
- **Labels:** `dependencies`
...
- **What:** Dependabot bump of `loader-utils` from 1.4.0 to 1.4.2 for ReDoS security fix.
...
- `0fd17bf4df5357b8bab6bbaab60ca15c3a2577b4` build(deps): bump loader-utils from 1.4.0 to 1.4.2

...
form-driven factory caplet, a ported `ClaudeCredentials` capability (0600 sidecar
+ single-shot `IssuedCredential`), and `setup.js` provisioning that mirrors the
genie sandbox wiring.

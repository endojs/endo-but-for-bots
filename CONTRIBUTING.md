...
Package scripts use `scripts/run-tsd.mjs` so every workspace gets the same
diagnostic formatting and exit-status behavior.
The script requires an explicit declaration entry and fixture glob.

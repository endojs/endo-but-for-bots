...
export const runPipeline = ({
  ...
  const ast = parseBabel(source, {
    ...
    ...babelParserOptions,
    // TODO: consider exposing this as an option; if enabled, `onParseError`
    // would never be called and an exception would be thrown instead.
    errorRecovery: true,
  ...
  if (ast.errors?.length) {
    result.errors = /** @type {BabelParseError[]} */ (ast.errors);
  }

 ...
 * preserving its Babel-specific metadata alongside `message` and `stack`.
 *
 ...
 * parse-error properties. Sending plain data instead (and reviving it in
...
const makeClonedParseError = error => ({
  ...
  syntaxPlugin: error.syntaxPlugin,

 ...
 * parse-error metadata would silently disappear in transit
...
export interface ClonedParseError {
  message: string;
  stack?: string;
  code: BabelParseError['code'];
  reasonCode: BabelParseError['reasonCode'];
  syntaxPlugin?: BabelParseError['syntaxPlugin'];
  missingPlugin?: BabelParseError['missingPlugin'];
  loc: BabelParseError['loc'];
  details: BabelParseError['details'];
  pos: BabelParseError['pos'];
}

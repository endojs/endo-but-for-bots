...
When a `sandbox-factory` _is_ present, `setup.js` requires
...
| `sandbox-factory configured but no workspace Mount cap`                                                        | `GENIE_WORKSPACE` was unset _after_ a slice-capable rollout.                                                                                                                                                                                               | Re-run `setup.js` with `GENIE_WORKSPACE=/path/to/workspace`; `setup.js` mints `workspace-mount` and re-introduces it.                                                                                       |

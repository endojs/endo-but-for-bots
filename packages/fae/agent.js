...
export const spawnWorkerLoop = async (
  ...
  const runAgent = async () => {
     ...
     * (endojs/endo-but-for-bots#125): a partial submission settling, or
     * an amendment of an already-settled message.  We do not rerun the
     * agentic loop for such re-emissions; the agent can call
     * `messageHistory(n)` to retrieve the prior text if it needs to

 ...
 *
 * Pairs with the daemon `editMessage` capability added in
 * endojs/endo-but-for-bots#125.  Use this to correct a prior reply,
 * progressively reveal a long answer, or settle a `done: false`
 * placeholder ("Thinking...") into a final response.  Only the
 * original sender may edit a message.
 *
 * @param {import('@endo/eventual-send').ERef<object>} powers
 * @returns {FaeTool}
 */
 ...
 * or outbox.  Pairs with the daemon `messageHistory` capability added
 * in endojs/endo-but-for-bots#125.  Use to inspect how an inbound
 * message evolved (helpful for "the human changed their mind"
 * reasoning) or to audit your own outbound revisions.
 *
 * @param {import('@endo/eventual-send').ERef<object>} powers
 * @returns {FaeTool}
 */

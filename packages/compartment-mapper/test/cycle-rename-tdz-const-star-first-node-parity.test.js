 ...
 * is `const y = 42`, main.js imports the star-reexporter first. This test
...
test('cyclic star export with renaming reexport, star first, const value (issue #59) - node parity', async t => {
  t.plan(1);

 ...
 * is `let y = 42`, main.js imports the star-reexporter first. This test
...
import {
  ...
  expectedProbeStarLetStarFirst,
} from './_cycle-rename-tdz-assertions.js';

test('cyclic star export with renaming reexport, star first, let value (issue #59) - node parity', async t => {
  t.plan(1);
  const namespace = await import(
    new URL(
      'fixtures-cycle-rename-tdz-let-star-first/node_modules/app/main.js',
      import.meta.url,
    ).href
  );
  assertCycleRenameTdz(t, namespace, expectedProbeStarLetStarFirst);
});

...
export const makeDirectoryMaker = ({
  ...
  const makeDirectoryNode = petStore => {
    ...
    const followLocatorNameChanges = {
      /**
       * @param {string} locator The locator whose pet-name changes to follow.
    ...
    const followNameChanges = {
      /**
       * @param {...string} petNamePath Path of pet names identifying the
       *   directory whose name changes to follow; empty selects this directory.

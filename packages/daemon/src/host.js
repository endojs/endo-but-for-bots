...
import { normalizeHttpClientPolicy } from './http-client-policy.js';
...
// The HTTP-client policy normalizer lives in its own module so a caller that
// only needs to validate a policy — the provisioning path, say — can reach it
// without loading the daemon core. Re-exported here because `provideHttpClient`
// and every existing importer name it on this module.
export { normalizeHttpClientPolicy };

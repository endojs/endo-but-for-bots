# Daemon-side splice plan - `bus-manager-endor.js`
...
`provideWorker` in `bus-manager-endor.js` (around line 467) currently
...
(1.5–2x win), echo 2.6 -> 1.0–1.5 ms (~2x win, dominated by the

...
// behavior. The two regression tests in
// `disconnect-error-display.test.js` pin the original symptom (an
// Error reason on `CTP_DISCONNECT` arrives at the peer as `{}`); this
// file pins the additional shapes `renderRejection` and the encoder
// have to handle.

...
// Exercises the degradation path: when the host does not provide `URL`
// and `URLSearchParams`, `lockdown()` must proceed without them and
// post-lockdown compartments must observe their absence. This mirrors
// the behavior on XS, where URL is not part of the host realm and there
// are no plans to introduce one.

...
- Compartment is a class that constructs isolated environments, with separate
  ...
  [_primordials_](https://github.com/tc39/how-we-work/blob/main/terminology.md#primordial)
...
- `setImmediate`/`clearImmediate`
  - You can generally replace `setImmediate(fn)`
    ...
    There are two queues: the _I/O queue_ (accessed by `setImmediate`), and the _Promise queue_ (accessed by
...
[_Realm_](https://www.ecma-international.org/ecma-262/10.0/index.html#sec-code-realms).

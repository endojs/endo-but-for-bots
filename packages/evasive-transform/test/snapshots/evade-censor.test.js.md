...
> Snapshot 2

    {
      file: undefined,
      ignoreList: [],
      mappings: ';;;;AAEA;AACA;AACA;AACO,SAASA,QAAQA,CAAA,EAAG;EACzB,OAAOC,OAAA,CAAAA,SAAS,CAACC,IAAI;AAAC;;ACJxB;AACA;AACA;AACO,SAASC,MAAMA,CAAA,EAAG;EACvB,OAAO,IAAI;AAAC',
      names: [
        'bambalam',
        'constants',
        'F_OK',
...
> Snapshot 2

    {
      file: undefined,
      ignoreList: [],
      mappings: 'AAAA,YAAY;;AAEZ,IAAIA,QAAQ,EAAEC,OAAO,CAAC,SAAS,CAAC;;AAEhC;AACA;AACA;AACA,SAASC,QAAQA,CAAA,EAAG;EAClB,OAAOF,OAAO,CAACG,SAAS,CAACC,IAAI;AAAC;;AAGhC;AACA;AACA;AACA,SAASC,MAAMA,CAAA,EAAG;EAChB,OAAO,IAAI;AAAC;;AAGdC,OAAO,CAACJ,SAAS,EAAEA,QAAQ;AAC3BI,OAAO,CAACD,OAAO,EAAEA,MAAM;AACvB;;AAEA;AACA',
      names: [
        'node_fs',
        'require',
        'bambalam',
...
## evadeCensor() - actual evasions in ESM
...
## evadeCensor() - actual evasions in ESM + elide
...
## evadeCensor() - onlyComments skips string and code evasions

...
const DARK = { name: 'dark', mode: 'dark', vars: { '--bg': '#0d1117', '--panel': '#161b22', '--edge': '#30363d', '--ink': '#e6edf3', '--mut': '#8b949e', '--acc': '#7c5cff', '--acc-fill': '#6b3fd6', '--acc2': '#2ea043', '--bad': '#f85149', '--you': '#479cff', '--you-fill': '#1f6feb', '--you-bg': '#11243f', '--you-edge': '#1f3b63', '--trace-bg': '#0b0e14', '--trace-edge': '#21262d', '--trace-ink': '#9aa4b2', '--trace-ok': '#8fd0a8', '--trace-bad': '#ff9e9e', '--trace-call': '#9fb0c9', '--trace-result': '#c9a96e', '--warn': '#d29922' } };

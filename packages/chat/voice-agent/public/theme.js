...
const LIGHT = { name: 'light', mode: 'light', vars: { '--bg': '#ffffff', '--panel': '#f3f5f8', '--edge': '#d0d7de', '--ink': '#1f2328', '--mut': '#636c76', '--acc': '#6b3fd6', '--acc2': '#1a7f37', '--bad': '#cf222e', '--you': '#0969da', '--you-bg': '#dbeafe', '--you-edge': '#9ec5fe', '--trace-bg': '#eef1f5', '--trace-edge': '#d0d7de', '--trace-ink': '#57606a', '--trace-ok': '#1a7f37', '--trace-bad': '#cf222e', '--trace-call': '#4b5563', '--trace-result': '#8a6d3b', '--warn': '#8a6500' } };

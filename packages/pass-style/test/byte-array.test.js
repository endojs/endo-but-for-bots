...
// Smoke tests: the minimal happy-path recognition of a frozen `Uint8Array`
// over an immutable `ArrayBuffer` as a `byteArray`. Folded in from the
// former `byteArray.test.js` when the two byte-array test files were merged.

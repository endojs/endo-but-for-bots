...
test('public API surface snapshot', t => {
  ...
  // an emulated frozen byteArray, so AVA attempts to read an absent `.buffer`.
  // Compare against AVA's checked-in human-readable report directly; this
  // retains the same reviewed fixture without depending on AVA's internals.

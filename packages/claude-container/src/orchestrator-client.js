...
/**
 * Subset of the orchestrator `Session` that `sendPrompt` needs at
 * runtime. Module reincarnation paths can construct one of these
 * from env vars without consulting the orchestrator for full
 * session state.
 *
 * @typedef {{ id: string, attachSocketPath?: string }} SessionForSend
 */

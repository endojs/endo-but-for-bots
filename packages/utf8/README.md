...
Accepts a mutable `Uint8Array`, a genuine view over an immutable
`ArrayBuffer`, or the emulated immutable `Uint8Array` wrapper.
...
Accepts the same `Uint8Array` forms as `decodeUtf8`.

...
# codes:
#
#   pnpm lint:sh                     # default severity warning
#   pnpm lint:sh --severity=error    # tighter gate
#   pnpm lint:sh -- -e SC2086        # exclude a code
#
...
# it installed can still run the rest of `pnpm lint` locally. CI installs

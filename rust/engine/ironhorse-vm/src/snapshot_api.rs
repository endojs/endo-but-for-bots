...
//! Shared `Machine`/`Realm` snapshots are currently refused; these rows describe
//! standalone `Interp` capture and restore.
...
pub use crate::interp::{
    ...
    SavedJumpRow, SegmentIteratorData, SegmenterData, SegmentsData,
};

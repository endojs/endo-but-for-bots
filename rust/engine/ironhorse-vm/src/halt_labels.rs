...
pub const REFUSED_LABELS: &[&str] = &[
    ...
    "host:arity-out-of-range",
    "host:callback-refused",
    "host:duplicate-service",
    "host:foreign-machine-value",
    "host:meter-overflow",
    "host:missing-restored-service",
    ...
    "machine:missing-restored-compiler",
    "machine:missing-restored-meter",
    "machine:unapplied-endowments",
    "machine:unknown-restored-environment",
    "machine:unknown-restored-identity",
    "machine:unknown-restored-root",

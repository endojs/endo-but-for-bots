...
impl BootTemplate {
    ...
    pub(crate) fn instantiate(&self) -> Interp {
        ...
        Interp {
            ...
            bound_functions: state.bound_functions.clone(),
            ...
            collators: state.collators.clone(),
            ...
            temporal_instants: state.temporal_instants.clone(),
            temporal_durations: state.temporal_durations.clone(),
            temporal_plains: state.temporal_plains.clone(),
            temporal_zoneds: state.temporal_zoneds.clone(),
            ...
            wrapper_data: state.wrapper_data.clone(),
            array_proto: state.array_proto,
            arrays,
            index_props,
            arguments_objects: state.arguments_objects.clone(),
            disposable_stacks: state.disposable_stacks.clone(),
            collections,
            side_refs,
            ...
            array_buffers: state.array_buffers.clone(),
            ...
            typed_arrays: state.typed_arrays.clone(),
            byte_offset_id: state.byte_offset_id,
            buffer_id: state.buffer_id,
            data_views: state.data_views.clone(),
            ...
            promise_functions: state.promise_functions.clone(),

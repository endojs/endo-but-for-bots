    ...
    fn dispatch_at_inner(&mut self, code: &[u8], start_pc: usize, return_depth: usize) -> Step {
        ...
        loop {
            ...
            match op {
                ...
                XS_CODE_TO_INSTANCE => {
                    dispatch_result!(self.dispatch_to_instance(), pc, self, return_depth, code);
                    pc += size as usize;
                }
                ...
                XS_CODE_FOR_OF | XS_CODE_FOR_AWAIT_OF => {
                    dispatch_result!(self.dispatch_for_of(code, op), pc, self, return_depth, code);
                    pc += size as usize;
                }
                ...
                XS_CODE_FOR_IN => {
                    dispatch_result!(self.dispatch_for_in(), pc, self, return_depth, code);
                    pc += size as usize;
                }

...
//! (`ironhorse_fuzz::comparison::results_agree`). This submodule-free test
//! replays the exact fuzz input through a local copy of that input grammar,
//! compiles the resulting program with the pure-Rust compiler, and runs it

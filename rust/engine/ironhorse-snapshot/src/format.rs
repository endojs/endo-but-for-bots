...
/// version 7 adds Intl bound-function links.
/// The reader accepts
/// [`IRONHORSE_FORMAT_VERSION_MIN_READ`]`..=`this and refuses anything
/// newer.
pub const IRONHORSE_FORMAT_VERSION: u32 = 7;
...
mod tests {
    ...
    /// accessor state; version 7 introduces Intl bound functions.
    #[test]
    fn the_write_stamp_is_past_the_side_table_addition() {
        assert!(IRONHORSE_FORMAT_VERSION >= 7, "the Intl bound atom is a format bump");

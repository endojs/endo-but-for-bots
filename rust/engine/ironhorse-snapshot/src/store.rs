...
pub const STORE_SCHEMA_VERSION: u32 = 18;
...
impl SmallState {
    /// Serialize: twenty-five sections, each `u32` length-prefixed, in
    ...
    /// accessors, Intl bound functions
    ...
    /// in schema 17 and Intl bound functions in schema 18
    ...
    /// Decode the twenty-five sections. Every section length is
    ...
    pub fn decode(p: &[u8]) -> Result<SmallState, StoreError> {
        ...
        // Same exact-consumption rule as the manifest: twenty-five

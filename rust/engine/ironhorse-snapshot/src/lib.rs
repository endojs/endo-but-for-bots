...
pub use store::{
    ...
    validate_store_content, CheckpointBatch, CommitStats, HeapStore, HeapStoreCommit, MemoryStore,
    SmallState, StoreError, StoreManifest, ValidatedStoreState, CHUNK_EXTENT_BYTES, SLOTS_PER_PAGE,

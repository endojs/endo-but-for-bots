...
/// Both engines complete with the same result and the frozen version-2 cost.
fn assert_version_two(source: &str) {
...
#[test]
fn detached_native_dot_call_has_version_two_costs() {
    ...
    assert_version_two("var n = 0; var a = 0; a = [1, 2]; n = a.push; n.call(a, 9); a.length");
    assert_version_two("var n = 0; var a = 0; a = [1, 2]; n = a.push; n.call(a, 9, 10); a.length");
}

#[test]
fn detached_native_dot_apply_has_version_two_costs() {
    ...
    assert_version_two("var n = 0; var a = 0; a = [1, 2]; n = a.push; n.apply(a, []); a.length");
    assert_version_two("var n = 0; var a = 0; a = [1, 2]; n = a.push; n.apply(a, [7]); a.length");
    assert_version_two(
...
fn detached_native_dot_apply_without_an_array_matches_a_zero_arg_call() {
    ...
    assert_version_two("var n = 0; var a = 0; a = [1, 2]; n = a.push; n.apply(a); a.length");
    assert_version_two("var n = 0; var a = 0; a = [3]; n = a.pop; n.apply(a)");
}

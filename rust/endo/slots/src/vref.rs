...
impl Vref {
    pub fn object_local(id: u64) -> Self {
        Vref { ty: VrefType::Object, direction: Direction::Local, durability: Durability::Ephemeral, id, subid: None, facet: None }
    }
    pub fn object_remote(id: u64) -> Self {
        Vref { ty: VrefType::Object, direction: Direction::Remote, durability: Durability::Ephemeral, id, subid: None, facet: None }
    }
    pub fn promise_local(id: u64) -> Self {
        Vref { ty: VrefType::Promise, direction: Direction::Local, durability: Durability::Ephemeral, id, subid: None, facet: None }
    }
    pub fn promise_remote(id: u64) -> Self {
        Vref { ty: VrefType::Promise, direction: Direction::Remote, durability: Durability::Ephemeral, id, subid: None, facet: None }
    }
    pub fn answer_local(id: u64) -> Self {
        Vref { ty: VrefType::Answer, direction: Direction::Local, durability: Durability::Ephemeral, id, subid: None, facet: None }
    }

    pub fn is_local(&self) -> bool {
        matches!(self.direction, Direction::Local)
    }
    ...
    pub fn parse(s: &str) -> Result<Self> {
        ...
        Ok(Vref { ty, direction, durability, id, subid, facet })
    }
...
mod tests {
    ...
    fn parse_object_local() {
        ...
        assert_eq!(v.direction, Direction::Local);
        assert_eq!(v.id, 1);
    ...
    fn parse_promise_remote() {
        ...
        assert_eq!(v.direction, Direction::Remote);
        assert_eq!(v.id, 42);
    }

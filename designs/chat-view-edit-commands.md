...
| --- | --- | --- | --- |
| `endojs/endo-but-for-bots` | [#42](https://github.com/endojs/endo-but-for-bots/pull/42) | open | `review/7-chat-markdown-render` (adds tests for view/cat/edit command executors and `openBlobViewer`) |

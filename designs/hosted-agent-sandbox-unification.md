...
Retained fresh-construction cancellation is a separate increment still in progress;
these core fences do not close that pending-constructor gap.
...
Closing this gap still requires retained construction cancellation before native
controller adoption.

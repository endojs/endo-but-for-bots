...
ReadableBlob `range`/`textRange` attenuation contract as the
filesystem/blob realization of sed-like reads and leaves rendered Git
outputs as a follow-up),

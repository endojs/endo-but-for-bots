...
flowchart TD
    ...
    subgraph LLM Agents
        ...
        eclaude[endo-claude]
        cagents[introduced-special-names]
        dform --> lalfp
        dval --> lalfp
        laltx --> lalfp
        lalfp --> fagent

...
[endor-packaging](endor-packaging.md) (added 2026-07-25; publishes `endor` as
a Rust crate and cross-compiled npm packages, with a Homebrew tap and a
single-version-source release workflow),
...
| [endor-packaging](endor-packaging.md) | 2026-07-25 | 2026-07-25 | Not Started |
...
| endor-packaging | Not Started | Publish `endor` as a Rust crate, cross-compiled npm packages (yay-style `@endo/endor` wrapper + per-platform `os`/`cpu`-gated packages), and a Homebrew tap; single-version-source release workflow with npm/build provenance and SHA256SUMS |
...
| endor-packaging | M-L | 1-2 weeks | 11 | Native matrix release workflow (`endor-v*`), yay-style npm wrapper + per-platform packages, crates.io publish with vendored XS sources, Homebrew tap, provenance/checksums; incremental tier roll-out |
...
| M11: Rust Daemon (`endor`) (was M6) | 7 (`endor-git-bindings`, `endor-registry-proxy-worker`, `daemon-endor-sqlite-iterate-streaming`, `endor-tui`, `endor-bus-tui`, `endor-native-zip-xs`, `endor-packaging`) | 16-24 weeks | 18-26 weeks |
...
| M11: Rust Daemon (`endor`) (was M6) | 16-24 weeks | 66-91 weeks | Q3 to Q4 2027 (research-heavy; may run in parallel) |

...
The 2026-08-31 update adds [ai-agent-requirements-quinnypig-screed](ai-agent-requirements-quinnypig-screed.md) (Reference), an analysis of Corey Quinn's AI-agent requirements thread against Endo's standing primitives.

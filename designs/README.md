...
| [hosted-agent-sandbox-unification](hosted-agent-sandbox-unification.md) | 2026-09-12 | 2026-09-21 | In Progress — Tokyo generation 152 runs `21bcb3d04`; session controls and public HTTPS trials passed; shared harness image code pushed, deployment awaits disk cleanup and remaining build/conformance checks; broader conformance pending |

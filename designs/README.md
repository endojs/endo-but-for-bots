...
| parallel-sync-browser | Proposed | showcase | New (2026-06-27): two-panel cis/trans file-tree browser whose headline is direct peer-to-peer CapTP sync (orchestrator brokers a locator exchange, then steps out of the byte path); composes mount + locator + weblet substrate, introduces no new daemon primitive |

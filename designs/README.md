...
2026-08-16, Not Started).** The P0-P4 slices above wire an *external* LLM client
(Claude Desktop, Cursor) *into* an Endo agent over the gateway's `/mcp`
termination. `@endo/claude` is the inverse: a confined `claude -p` that *is* an

...
| [cli-http-client](cli-http-client.md) | 2026-05-09 | 2026-08-17 | In Progress (Phase 1 `endo http mk` landed on the policy-based `provideHttpClient` client, PR #1014; formula packaging superseded in part by [endo-fetch](endo-fetch.md)) |

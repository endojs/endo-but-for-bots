...
| [hosted-agent-sandbox-unification](hosted-agent-sandbox-unification.md) | 2026-09-12 | 2026-09-24 | In Progress — shared provisioner, factory and execution envelope; journal-owned Claude native checkpoints and ambient-resume retirement implemented, not deployed; compaction/failure recovery and current live acceptance pending; [refactor alignment audit](../packages/floot/REFACTOR-ALIGNMENT.md) records current gaps alongside the [architecture audit/remediation register](../packages/floot/ARCHITECTURE-AUDIT.md) |

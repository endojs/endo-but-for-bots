...
| [daemon-move-transfer-negotiation](daemon-move-transfer-negotiation.md) | 2026-06-08 | 2026-06-08 | Not Started |
...
| daemon-move-transfer-negotiation | Not Started | Six-tier transfer-mechanism ladder (POSIX `renameat` → mount-scoped renameat → same-host copy → CAS refcount swap → CapTP byte stream → out-of-band Git push/pull) with substrate-bind-time sealer / unsealer pairs (brand-and-trademark) at the negotiation core. Picks option (a): single polymorphic `move` extended with sibling `moveWithReport`. Takes the stance that the negotiation token rides direct CapTP method calls on the existing session, not a `value` message envelope |
...
| M9: UX & Tooling (was M4) | 8-11 weeks | 34-45 weeks | Mid February to mid April 2027 |
| M10: Confinement & Ecosystem (was M5) | 14-20 weeks | 48-65 weeks | Late May to early September 2027 |
| M11: Rust Daemon (`endor`) (was M6) | 12-17 weeks | 60-82 weeks | Q3 to Q4 2027 (research-heavy; may run in parallel) |

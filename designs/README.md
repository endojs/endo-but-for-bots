...
| thesis-translation | Proposed | Docs-only, parallel-track: phased Jessie/OCapN edition of the Robust Composition dissertation at docs.endojs.org/thesis/; publication gated on author permission; off the milestone critical path |
...
| thesis-translation | XL | 2-3 weeks across 5 docs-only PRs (phase 1 ~1 day) | 10 | Phased translation of the Robust Composition dissertation; permission-gated, parallel-track, excluded from milestone duration totals |
...
| M10: Confinement & Ecosystem (was M5) | 6 (`endo-posix-sandbox`, `daemon-capability-persona`, `daemon-capability-bank`, `endoclaw-browser`, `endoclaw-channel-bridges`, `endoclaw-skill-registry`) + 1 parallel-track docs item (`thesis-translation`, permission-gated, excluded from effort totals) | 14-20 weeks | 16-22 weeks |

...
| [hosted-agent-sandbox-unification](hosted-agent-sandbox-unification.md) | 2026-09-12 | 2026-09-23 | In Progress — shared provisioner, factory and execution envelope; unified binding vocabulary and immutable Claude/Codex state-root pins implemented, not deployed; old-release retirement and live rebind acceptance pending; [architecture audit/remediation register](../packages/floot/ARCHITECTURE-AUDIT.md) records open FA-01–FA-13 findings and compatibility-free retirement plan |

...
| [hosted-agent-sandbox-unification](hosted-agent-sandbox-unification.md) | 2026-09-12 | 2026-09-21 | In Progress — Claude queue backpressure, payload-free overflow diagnostics, and durable transcript recovery implemented; live verification and final conformance pending |

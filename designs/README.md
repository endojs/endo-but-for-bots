...
| hardener-indexed-cardinality | S | 1 day | — | Out-of-milestone `master`-based optimization: captured intrinsic TypedArray length, pure-indexed cardinality guard, regression matrix, and focused benchmark |

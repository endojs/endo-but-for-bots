...
| **Total remaining** | **59** + 7 M5 rows (4 in-flight + 3 design gaps) + 1 M6 own-work row | **~57-78 weeks** (the M2 addition is ~1-2 days, below the week granularity of this total) + M5 4-6 weeks + M6 ~2 weeks | **~69-94 weeks** |

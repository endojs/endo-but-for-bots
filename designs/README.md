...
| [google-sheet-pubsub](google-sheet-pubsub.md) | 2026-07-07 | 2026-07-07 | Proposed |
...
| google-sheet-pubsub | Proposed | `@endo/google-drive-watch` Drive `files.watch` channel substrate + push trigger behind exo-google-sheets `follow`; rides endoclaw-webhooks |
...
| google-sheet-pubsub | S-M | 3 days | 7 | `@endo/google-drive-watch` channel substrate + follow-engine refactor; webhook-binding phase gated on endoclaw-webhooks impl |
...
| M7: Weblets & Integrations (was M3) | 13 (`familiar-unified-weblet-server`, `familiar-chat-weblet-hosting`, `cli-store-verb-text-modes`, `cli-edit-verb`, `daemon-weblet-application`, `exo-zip-package`, `endoclaw-oauth`, `exo-google-sheets`, `google-sheet-pubsub`, `endoclaw-proactive-messages`, `endoclaw-notifications`, `endoclaw-webhooks`, `endoclaw-voice`) | 6-8 weeks | 8-11 weeks |
...
| **Total remaining** | **59** + 7 M5 rows (4 in-flight + 3 design gaps) + 1 M6 own-work row | **~57-78 weeks** + M5 4-6 weeks + M6 ~2 weeks | **~69-94 weeks** |

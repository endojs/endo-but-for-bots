...
[privacy-card-issuer](privacy-card-issuer.md) (added 2026-07-04;
Privacy.com virtual cards as an unconfined daemon caplet in the
endoclaw-oauth credential idiom: the owner's API key stays inside the
caplet while guests and agents hold budgeted `CardIssuer` facets that
...
| [privacy-card-issuer](privacy-card-issuer.md) | 2026-07-04 | 2026-07-04 | In Progress |
...
| M7: Weblets & Integrations (was M3) | 12 (`familiar-unified-weblet-server`, `familiar-chat-weblet-hosting`, `cli-store-verb-text-modes`, `cli-edit-verb`, `daemon-weblet-application`, `exo-zip-package`, `endoclaw-oauth`, `privacy-card-issuer`, `endoclaw-proactive-messages`, `endoclaw-notifications`, `endoclaw-webhooks`, `endoclaw-voice`) | 6-8 weeks | 8-11 weeks |

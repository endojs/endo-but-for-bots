...
| --- | --- | --- | --- |
| `endojs/endo-but-for-bots` | [#29](https://github.com/endojs/endo-but-for-bots/pull/29) | open | `design/ocapn-tcp-syrup-framing` (comma-less netstring variant for TCP) |

...
| --- | --- | --- | --- |
| `endojs/endo-but-for-bots` | [#39](https://github.com/endojs/endo-but-for-bots/pull/39) | open | `review/5-formula-introspection` (host.inspect, listWithTypes, identifyType) |
